...
func (c *relayClientClient) UpdateProfile(ctx context.Context, in *ProfileInfo, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
	err := c.cc.Invoke(ctx, RelayClient_UpdateProfile_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *relayClientClient) GetProfilePic(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*ProfilePicResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ProfilePicResponse)
	err := c.cc.Invoke(ctx, RelayClient_GetProfilePic_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *relayClientClient) SetProfilePic(ctx context.Context, in *SetProfilePicRequest, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
	err := c.cc.Invoke(ctx, RelayClient_SetProfilePic_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedRelayClientServer) UpdateProfile(context.Context, *ProfileInfo) (*Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateProfile not implemented")
}
func (UnimplementedRelayClientServer) GetProfilePic(context.Context, *Empty) (*ProfilePicResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetProfilePic not implemented")
}
...
func _RelayClient_UpdateProfile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ProfileInfo)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RelayClientServer).UpdateProfile(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RelayClient_UpdateProfile_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RelayClientServer).UpdateProfile(ctx, req.(*ProfileInfo))
	}
	return interceptor(ctx, in, info, handler)
}

func _RelayClient_GetProfilePic_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RelayClientServer).GetProfilePic(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RelayClient_GetProfilePic_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RelayClientServer).GetProfilePic(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}

func _RelayClient_SetProfilePic_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SetProfilePicRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RelayClientServer).SetProfilePic(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RelayClient_SetProfilePic_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RelayClientServer).SetProfilePic(ctx, req.(*SetProfilePicRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var RelayClient_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _RelayClient_UpdateProfile_Handler,
		},
		{
			MethodName: "GetProfilePic",
			Handler:    _RelayClient_GetProfilePic_Handler,
		},
		{
